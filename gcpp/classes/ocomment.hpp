...
#define oCOMMENT_B_PERMANENT (1 << 3)
#define oCOMMENT_B_PREFACE (1 << 4)
#define oCOMMENT_B_PACKAGE (1 << 5)
#define oCOMMENT_B_RELEASE (1 << 6)
#define oCOMMENT_B_LICENSE (1 << 7)
#define oCOMMENT_B_SPECIAL (1 << 8)
