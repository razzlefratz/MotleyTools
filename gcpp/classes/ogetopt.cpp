/*====================================================================*
 *
 *   ogetopt.cpp - implementation of the ogetopt class.
 *
 *   this is a posix compliant getopt() function that supports absolutely
 ...
 *   version of getopt and after trying to fix it we decided to start over;
 *
 ...
 *   be enough; or use our getopt.h as an alternative; or you can add the
 ...
 *    optind = 1;
 *    opterr = 1;
 *    while ((c = options.getopt(argc, argv, ":ab:c")) != -1)
 *    {
 *       switch(c)
 *       {
 *          case 'a': // optopt is 'a'
...
#ifndef oGETOPT_SOURCE
#define oGETOPT_SOURCE
...
signed ogetopt::operator++ (signed)
...
/*====================================================================*
 *
 *   signed getopt(int argc, char const * argv[], char const * options);
 *
 *
 *--------------------------------------------------------------------*/
