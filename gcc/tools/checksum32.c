 ...
 *   memory.h
 *
 *   compute the 32-bit checksum of a memory region; the calculated
 *   checksum is the one's complement of the XOR of 32-bit words in
 *   that region; this means that extent should be an even multiple 
 *   of 4-bytes because trailing bytes will be excluded; 
 *
