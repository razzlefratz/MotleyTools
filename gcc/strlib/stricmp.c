 ...
 *   or follows the second, using lowercase comparison;
 *
...
#ifndef STRICMP_SOURCE
#define STRICMP_SOURCE

#include <ctype.h>
#include "../strlib/strlib.h"

int stricmp (register char const *string1, register char const *string2) 
