...
/*====================================================================*
 *
 *   void client (char const * pathname, flag_t flags);
 *   
 *--------------------------------------------------------------------*/

static void client (char const * pathname, flag_t flags) 
...

{
	...
	if (argc) 
	{
		error (1, ECANCELED, ERROR_UNWANTED);
	}
	client (SOCKET_NAME, flags);
	return (0);
}
